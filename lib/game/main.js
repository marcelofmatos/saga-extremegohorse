...
MyGame = ig.Game.extend({
	...
	gameMusic: new ig.Sound('media/sounds/gameMusic.*', false),
	...
	setupCamera: function() {
		...
		let distanceFactor = ig.ua.mobile ? 3.5 : 6
    	this.camera.lookAhead.x = ig.system.width/distanceFactor;
