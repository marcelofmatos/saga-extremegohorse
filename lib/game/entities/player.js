...
EntityPlayer = ig.Entity.extend({
	...
	animSheet: new ig.AnimationSheet( 'media/running-horse.png', 161.2, 100 ),	
	
	// sfxHurt: new ig.Sound( 'media/sounds/hurt.*' ),
	sfxHurt: new ig.Sound( 'media/sounds/horse-neigh.*' ),
	...
	init: function( x, y, settings ) {
		...
		// Add the animations
		this.addAnim( 'idle', 0.4, [15,15,15,15,15,15,15,15,16,16,16,8] );
	...
	update: function() {
		...
		if( ig.input.pressed('shoot') ) {
			ig.game.spawnEntity( EntityFireball, this.pos.x+60, this.pos.y+30, {flip:this.flip} );
		}
